object frmMain: TfrmMain
  ...
  object qrSalesByQuarter: TQuery
    DatabaseName = 'DemosDB'
    SQL.Strings = (
      'SELECT'
      ...
      'WHERE'
        ...
        '  P.ID = O.ProductID AND O.PurchaseDate BETWEEN :StartDate AND :' +
        'FinishDate '
      'GROUP BY'
      '  P.Name, O.ProductID')
    Left = 388
  ...
  object mmMain: TMainMenu
    ...
    object miView: TMenuItem
      ...
      object miStackedBarDiagram: TMenuItem
        Caption = 'Stacked Bar Diagram'
        GroupIndex = 1
        RadioItem = True
        Visible = False
        OnClick = miStackedBarDiagramClick
      end
      object N1: TMenuItem
        Caption = '-'
        GroupIndex = 1
