...
type
  TfrmMain = class(TForm)
    ...
    procedure miStackedBarDiagramClick(Sender: TObject);
    ...
    if AChart.DiagramBar.Active then
      ...
      if AChart.DiagramLine.Active then
        ...
        if AChart.DiagramArea.Active then
          ...
          if AChart.DiagramPie.Active then
            miPieDiagram.Checked := True
          else
            miStackedBarDiagram.Checked := True;
...
procedure TfrmMain.miStackedBarDiagramClick(Sender: TObject);
begin
