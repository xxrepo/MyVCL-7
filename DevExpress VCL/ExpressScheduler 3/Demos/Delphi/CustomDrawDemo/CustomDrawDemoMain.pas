...
uses
  ...
  cxSchedulerYearView, cxGeometry, cxLookAndFeelPainters,
  cxSchedulerHolidays, cxSchedulerGanttView, dxSkinsCore,
  dxSkinsDefaultPainters, dxSkinscxScheduler3Painter;
