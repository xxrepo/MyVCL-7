...
USERES("PrintCapabilities.res");
USEUNIT("PrintCapabilities_ATL.cpp");
USETLB("PrintCapabilities.tlb");
USEUNIT("PrintCapabilities_TLB.cpp");
USEUNIT("dxPSContextMenuImpl.cpp"); /* dxPSContextMenu: CoClass */
USERES("MenuImages.res");
//---------------------------------------------------------------------------
...
BEGIN_OBJECT_MAP(ObjectMap)
  OBJECT_ENTRY(CLSID_dxPSContextMenu, TdxPSContextMenuImpl)
END_OBJECT_MAP()
