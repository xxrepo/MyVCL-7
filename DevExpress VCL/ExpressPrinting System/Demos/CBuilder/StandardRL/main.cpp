...
//---------------------------------------------------------------------------
void __fastcall TMainForm::DrawGridDrawCell(TObject *Sender, int Col,
...
int __stdcall EnumFontFamProc(const LOGFONT *LogFont,const TEXTMETRIC *TextMetric, unsigned long FontType, long Data)
{
  ...
  switch (FontType)
  {
   case TRUETYPE_FONTTYPE:
     S->AddObject(LogFont->lfFaceName, MainForm->TtfBitmap);
   break;
   case RASTER_FONTTYPE:
     S->AddObject(LogFont->lfFaceName, MainForm->SysBitmap);
   break;
   case DEVICE_FONTTYPE:
     S->AddObject(LogFont->lfFaceName, MainForm->DevBitmap);
   break;
  }
...
//---------------------------------------------------------------------------
void __fastcall TMainForm::BuildDriverList()
{
...
//---------------------------------------------------------------------------
void __fastcall TMainForm::FontsListDrawItem(TWinControl *Control,
...
//---------------------------------------------------------------------------
void __fastcall TMainForm::DrawFlag(int Row, int Col, TRect &Rect, TCanvas *ACanvas)
{
...
//---------------------------------------------------------------------------
void __fastcall TMainForm::dxComponentPrinter1Link2CustomDrawCell(
...
//---------------------------------------------------------------------------
void __fastcall TMainForm::BuildTree(String APath, TTreeNode *AItem)
{
...
void __fastcall TMainForm::TreeViewExpanded(TObject *Sender,
      TTreeNode *Node)
{
  Node->StateIndex = 7;
}
...
void __fastcall TMainForm::TreeViewCollapsed(TObject *Sender,
      TTreeNode *Node)
{
  Node->StateIndex = 6;
}
...
void __fastcall TMainForm::cbDrivesChange(TObject *Sender)
{
...
//---------------------------------------------------------------------------
String __fastcall TMainForm::GetNodeFullPath(TTreeNode *Node)
{
  String Result;
...
//---------------------------------------------------------------------------
void __fastcall TMainForm::TreeViewExpanding(TObject *Sender,
