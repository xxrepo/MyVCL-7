...
void __fastcall TcxTreeListRLMainForm::actShowDemoDescriptionExecute(
      TObject *Sender)
{
...
void __fastcall TcxTreeListRLMainForm::actNativeStyleExecute(
      TObject *Sender)
{
  tlPlanets->LookAndFeel->NativeStyle = !tlPlanets->LookAndFeel->NativeStyle;
  ((TCustomAction*)Sender)->Checked = !((TCustomAction*)Sender)->Checked;
...
void __fastcall TcxTreeListRLMainForm::actDXOnTheWebExecute(
      TObject *Sender)
{
...
void __fastcall TcxTreeListRLMainForm::AlwaysEnabled(TObject *Sender)
{
  ((TCustomAction*)Sender)->Enabled = true;
}
//---------------------------------------------------------------------------

void __fastcall TcxTreeListRLMainForm::actExitExecute(TObject *Sender)
{
  Close();  
}
//---------------------------------------------------------------------------
...
void __fastcall TcxTreeListRLMainForm::actPageSetupExecute(TObject *Sender)
{
  dxComponentPrinter->PageSetup(NULL);
}
//---------------------------------------------------------------------------

void __fastcall TcxTreeListRLMainForm::actPreviewExecute(TObject *Sender)
{
  dxComponentPrinter->Preview(true, NULL);
}
//---------------------------------------------------------------------------

void __fastcall TcxTreeListRLMainForm::actPrintExecute(TObject *Sender)
{
  dxComponentPrinter->Print(true, NULL, NULL);
}
//---------------------------------------------------------------------------

void __fastcall TcxTreeListRLMainForm::actDesignerExecute(TObject *Sender)
{
