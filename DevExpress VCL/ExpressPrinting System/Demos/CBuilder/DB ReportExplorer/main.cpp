...
void __fastcall TfmMain::pmExplorerPopup(TObject *Sender)
{
  ...
  pmiExplorerProperties->Enabled =
    ExplorerTree->CanShowPropertySheetsForSelectedItem();
}
//---------------------------------------------------------------------------
...
{
  tblFolders->Close();
  tblFolders->DatabaseName = "..\\..\\Data";
  tblFolders->Open();

  tblItems->Close();
  tblItems->DatabaseName = "..\\..\\Data";
  tblItems->Open();
}
//---------------------------------------------------------------------------
