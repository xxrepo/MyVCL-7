...
//---------------------------------------------------------------------------
class TSpreadSheetRLMainForm : public TForm
{
...
public:		// User declarations
  __fastcall TSpreadSheetRLMainForm(TComponent* Owner);
};
//---------------------------------------------------------------------------
extern PACKAGE TSpreadSheetRLMainForm *SpreadSheetRLMainForm;
//---------------------------------------------------------------------------
#endif
