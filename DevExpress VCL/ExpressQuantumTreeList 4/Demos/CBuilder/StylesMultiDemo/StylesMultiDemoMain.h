...
__published:	// IDE-managed Components
  ...
  void __fastcall tlStyleSheetsIsGroupNode(TObject *Sender,
    TcxTreeListNode *ANode, bool &IsGroup);
  void __fastcall tlStyleSheetsStylesGetContentStyle(TObject *Sender,
    TObject *AItem, TcxTreeListNode *ANode, TcxStyle *&AStyle);
  void __fastcall tlStyleSheetsStylesGetNodeIndentStyle(TObject *Sender,
...
private:
  ...
  void __fastcall SetCheckedNode(TcxTreeListNode *ANode);
