...
#ifndef EQGrid6RLMainH
#define EQGrid6RLMainH
//---------------------------------------------------------------------------
#include <Classes.hpp>
...
//---------------------------------------------------------------------------
class TEQGrid6RLMainForm : public TDemoBasicMainForm
{
...
public:		// User declarations
  __fastcall TEQGrid6RLMainForm(TComponent* Owner);
};
//---------------------------------------------------------------------------
extern PACKAGE TEQGrid6RLMainForm *EQGrid6RLMainForm;
//---------------------------------------------------------------------------
#endif
