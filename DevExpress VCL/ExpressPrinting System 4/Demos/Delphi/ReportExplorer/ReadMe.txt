...
cannot be used, because last ones are needed specific ReportItems for rendering from these Libraries.
    ...
    In case you own them, just uncomment follow units in uses clause of "Main.pas" (Main.hpp)
      - dxPScxSSLnk for ExpressSpreadSheet
      - dxPSdxLC2Lnk for ExpressLayoutControl
      - dxPScxCommon for ExpressEditors 
         (also needed for ExpressQuntumGrid, ExpressQuntumTree and ExpressVerticalGrid)
