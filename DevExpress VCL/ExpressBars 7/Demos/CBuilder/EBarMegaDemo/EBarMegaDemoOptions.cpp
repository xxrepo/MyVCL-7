...
void __fastcall TEBarMegaDemoOptionsForm::btnClearClick(TObject *Sender)
{
  ImSideBarbkPicture->Picture = NULL;
  EBarMegaDemoMainForm->dxSideBar->BkPicture = NULL;
}
//---------------------------------------------------------------------------

void __fastcall TEBarMegaDemoOptionsForm::cbBorderStyleClick(TObject *Sender)
{
   switch(cbBorderStyle->ItemIndex) {
...
void __fastcall TEBarMegaDemoOptionsForm::cbPaintStyleClick(TObject *Sender)
{
   switch(cbPaintStyle->ItemIndex) {
    case 0: EBarMegaDemoMainForm->dxSideBar->PaintStyle = sbpsFlat; break;
    case 1: EBarMegaDemoMainForm->dxSideBar->PaintStyle = sbpsStandard; break;
