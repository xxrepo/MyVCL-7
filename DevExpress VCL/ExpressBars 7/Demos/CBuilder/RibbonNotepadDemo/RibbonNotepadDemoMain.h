...
class TColorPickerController : public TObject
{
  ...
  public:
	__fastcall TColorPickerController(TdxRibbonGalleryItem *AColorItem, TdxRibbonGalleryItem *AColorMapItem, TdxRibbonPopupMenu *AFontColorPopupMenu, TdxCustomRibbon *ARibbon);
...
__published:	// IDE-managed Components
	...
	TPaintBox *pbFrameBackground;
	TLabel *lblSupport;
	TPaintBox *pbSeparator;
	TLabel *lblHelpBars;
	TImage *imDot1;
	TImage *imDot2;
	TLabel *lblHelpDocking;
	TLabel *lblSupportCenter;
	TImage *imDot3;
	TLabel *lblLinks;
	TPaintBox *pbSeparator2;
	TLabel *lblProducts;
    TImage *imDot4;
	TImage *imDot5;
	TLabel *lblClientCenter;
	TLabel *lblDXonWeb;
	TImage *imDot6;
	TLabel *lblDownloads;
	TImage *Image1;
	...
	TPaintBox *pbFrameBackground2;
	TLabel *lbAboutDemo;
	TPaintBox *pbSeparator3;
	TMemo *meAbout;
	TImage *imLogo;
	...
	void __fastcall EditorMouseDown(TObject *Sender, TMouseButton Button, TShiftState Shift, int X, int Y);
	void __fastcall EditorMouseUp(TObject *Sender, TMouseButton Button, TShiftState Shift, int X, int Y);
	void __fastcall RibbonResize(TObject *Sender);
	void __fastcall FormCloseQuery(TObject *Sender, bool &CanClose);
	void __fastcall FormActivate(TObject *Sender);
	void __fastcall ApplicationMenuRecentDocumentsClick(TObject *Sender, int AIndex);
	...
	void __fastcall pbFrameBackgroundPaint(TObject *Sender);
	void __fastcall pbSeparatorPaint(TObject *Sender);
	void __fastcall bvtsHelpResize(TObject *Sender);
	void __fastcall bvtsAboutResize(TObject *Sender);
private:
	...
	void RibbonAboutDemoLoad(TStrings *AItems);
	...
	void UpdateRibbonDemoStyle(TRibbonDemoStyle AStyle);
public:
