...
begin
  ...
  //FCustomCellProps.ABrush := TBrush.Create;
  //FCustomCellProps.AFont := TFont.Create;
end;

destructor TBaseGrid.Destroy;
begin
  //FCustomCellProps.ABrush.Free;
  //FCustomCellProps.AFont.Free;
  ClearProps;
  inherited;
end;
...
begin
  ...
  (*
  FCustomCellProps.AState := AState;
  FCustomCellProps.ABrush.Assign(Canvas.Brush);
  FCustomCellProps.AColorTo := AColorTo;
  FCustomCellProps.AMirrorColor := AMirrorColor;
  FCustomCellProps.AMirrorColorTo := AMirrorColorTo;
  FCustomCellProps.AFont.Assign(Canvas.Font);
  FCustomCellProps.HA := HA;
  FCustomCellProps.VA := VA;
  FCustomCellProps.WW := WW;
  FCustomCellProps.GD := GD;
  *)
