...
var
 ...
 // ButtonNames: array[TCommonButton] of string = ('OK', 'Да', 'Нет', 'Отмена', 'Повтор', 'Прервать');
  ButtonCaptions: array[TCommonButton] of Pointer;
//  ButtonCaptions: array[TCommonButton] of string = ('OK', 'Да', 'Нет', 'Отмена', 'Повтор', 'Прервать');
procedure Register;
