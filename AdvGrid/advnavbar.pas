...
uses
  Classes, Controls, ExtCtrls, Messages, Windows, Forms, AdvStyleIF,
{$IFDEF DELPHI6_LVL}
  Types,
{$ENDIF}
...
type
  ...
  TAdvNavBarStyle = (esOffice2003Blue, esOffice2003Silver, esOffice2003Olive, esOffice2003Classic, esOffice2007Luna, esOffice2007Obsidian, esWindowsXP, esWhidbey, esCustom, esOffice2007Silver, esWindowsVista, esWindows7, esTerminal);
  ...
  begin
    ...
    esWindowsXP:
        ...
        begin
          ...
          SectionColor := clBtnFace;    //define
          SectionColorTo := clBtnFace;  //define
