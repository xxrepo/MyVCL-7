...
uses
  ...
  Comobj, Activex, AdvStyleIF, ImgList, AdvSmoothTheme,
...
begin
  case LookupBar.Position of
    pLeft:   Result := Bounds(InsideRect.Left + LookupBar.GetWidth, InsideRect.Top + Header.GetHeight, InsideRect.Right - InsideRect.Left - GetShadowOffset,
    InsideRect.Bottom - InsideRect.Top - Footer.GetHeight - Header.GetHeight - GetShadowOffset);
    pRight:   Result := Bounds(InsideRect.Left, InsideRect.Top + Header.GetHeight, InsideRect.Right - LookupBar.GetWidth - InsideRect.Left - GetShadowOffset,
    InsideRect.Bottom - InsideRect.Top - Footer.GetHeight - Header.GetHeight - GetShadowOffset);
  end;
end;
...
begin
  ...
  begin
    ...
    begin
      h := ((Self.Height - Header.GetHeight - Footer.GetHeight - GetShadowOffset));
          ...
          begin
            ...
            begin
              ...
              begin
                ...
                if Assigned(aDispItem) then
                begin
                  FScPosTo := aDispItem.ItemRect.Top - Header.GetHeight;
                  FCurrentScPos := FScPosTo;
                end;
              end;
...
begin
  ...
  begin
    ...
    begin
      ...
      fcaptionr := MakeRect(gppointf.X, gppointf.Y, src.Width, src.Height);
...
begin
  ...
  //OutputDebugString(PChar('Sel Index' + Inttostr(FOwner.FSelectedItemIndex)));
end;
