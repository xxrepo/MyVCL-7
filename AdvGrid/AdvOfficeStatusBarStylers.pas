...
type
  ...
  TOfficeStatusBarStyle = (psOffice2003Blue, psOffice2003Silver, psOffice2003Olive, psOffice2003Classic, psOffice2007Luna, psOffice2007Obsidian, psWindowsXP, psWhidbey, psCustom, psOffice2007Silver, psWindowsVista, psWindows7, psTerminal);
...
;
        ...
        PanelAppearanceLight.ColorHot := $FDFBFA;
        PanelAppearanceLight.ColorHotTo := $FDF3EB;
        PanelAppearanceLight.ColorMirrorHot := $FDF3EB;
        PanelAppearanceLight.ColorMirrorHotTo := $FDFBFA;
        PanelAppearanceLight.BorderColorHot := $E3B28D;
        PanelAppearanceLight.ColorDown := $FCEBDC;
        PanelAppearanceLight.ColorDownTo := $FCDBC1;
        PanelAppearanceLight.ColorMirrorDown := $FCDBC1;
        PanelAppearanceLight.ColorMirrorDownTo := $FCEBDC;
        PanelAppearanceLight.BorderColorDown := clHighLight;

        { PanelAppearanceDark }
        PanelAppearanceDark.BorderColor := clNone;
        PanelAppearanceDark.Color := $FCDBC1;
        PanelAppearanceDark.ColorTo := $FCDBC1;
        PanelAppearanceDark.ColorMirror := clNone;
        PanelAppearanceDark.ColorMirrorTo := clNone;
        ...
        PanelAppearanceDark.ColorHot := $FDFBFA;
        PanelAppearanceDark.ColorHotTo := $FDF3EB;
        PanelAppearanceDark.ColorMirrorHot := $FDF3EB;
        PanelAppearanceDark.ColorMirrorHotTo := $FDFBFA;
        PanelAppearanceDark.BorderColorHot := $E3B28D;
        PanelAppearanceDark.ColorDown := $FCEBDC;
        PanelAppearanceDark.ColorDownTo := $FCDBC1;
        PanelAppearanceDark.ColorMirrorDown := $FCDBC1;
        PanelAppearanceDark.ColorMirrorDownTo := $FCEBDC;
        PanelAppearanceDark.BorderColorDown := clHighLight;
