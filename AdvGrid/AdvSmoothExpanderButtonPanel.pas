...
begin
  ...
  FVerticalMargin := 35;
  FHorizontalMargin := 5;
  FCache := TGPBitmap.Create(Width, Height - ButtonVerticalMargin, PixelFormat32bppARGB); // CreateWH(Width, Height - ButtonVerticalMargin);
...
begin
  ...
  begin
    ...
    if Expanded then
    begin
      FCache := TGPBitmap.Create(Width, Height - 2, PixelFormat32bppARGB); //CreateWH(Width, Height - 2)
    end
    else
      FCache := TGPBitmap.Create(Width, h, PixelFormat32bppARGB); //CreateWH(Width, h);
