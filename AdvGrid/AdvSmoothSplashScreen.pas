...
type
  ...
  TItemLocation = (ilTopLeft, ilTopRight, ilBottomLeft, ilBottomRight, ilCustom);
  ...
  private
    ...
    FTextRendering: TAdvSmoothSplashScreenTextRenderingHint;    // Timer used to force focus to main form
    function GetVersion: string;
    procedure SetVersion(const Value: string);
    function GetVersionNr: Integer;
