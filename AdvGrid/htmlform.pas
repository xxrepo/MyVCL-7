...
{$ENDIF}
  ...
  private
    ...
    procedure DoPaint(bkg: Boolean = false);
...
procedure THTMLForm.DoPaint(bkg: Boolean = false);
var
...
//  if bkg then
  begin
    ...
    begin
      ...
      ACanvas.Rectangle(Bounds(r.left,r.top,r.right - r.Left,r.bottom - r.Top));
    end;
  end;
...
procedure THTMLForm.SetBordercolor(const Value: TColor);
begin
