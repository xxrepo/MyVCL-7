...
type
  ...
  TToolPanelStyle = (esOffice2003Blue, esOffice2003Silver, esOffice2003Olive, esOffice2003Classic, esOffice2007Luna, esOffice2007Obsidian, esWindowsXP, esWhidbey, esCustom, esOffice2007Silver, esWindowsVista, esWindows7, esTerminal);
...
{$ENDIF}
  ...
  public
    ...
    property TextDirection: TTextDirection read FTextDirection write SetTextDirection;
  published
    property Alignment;
...
begin      
  ...
  begin
    ...
    if not (csDesigning in ComponentState) and (csDestroying in ComponentState) then
    begin
      FPanelForm.Free;
      FPanelForm := nil;
    end;
