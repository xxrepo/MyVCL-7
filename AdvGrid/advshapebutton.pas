  ...
  begin
    ...
    begin
      AdvPreviewMenu.SetMenuButtonAppearance(Appearance.BorderColorDown, Appearance.InnerBorderColorDown,
        ...
        Appearance.MenuShapeColorDown, Appearance.ShowMenuShape, PictureDown);
    end;
...
procedure TAdvCustomShapeButton.ChangeStyle(AWin7: Boolean);
begin
  //in case embedded in AdvToolBar
  if AWin7 then
  begin
  ...
  //previewmenu
  if Assigned(AdvPreviewMenu) then
      AdvPreviewMenu.ChangeStyle(AWin7);
end;
