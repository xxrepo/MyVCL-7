...
// Escher records
  ...
  //This functions do not take Continue records. use them with care, only where we are sure we don't have continues
  ...
  procedure GetSimpleString(const Length16Bit: boolean ;const Pdata: PArrayOfByte; const tPos: integer;const UseExtStrLen: boolean; const ExtStrLen: Cardinal; var St: widestring; var StSize: integer);
