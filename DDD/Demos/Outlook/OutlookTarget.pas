...
uses
  ...
  Menus, ActnList, DropComboTarget;
...
type
  ...
  TFormOutlookTarget = class(TForm)
    ...
    DropEmptyTarget12: TDropEmptyTarget;
...
begin
  //1013 DropEmptyTarget1.PasteFromClipboard;
end;

procedure TFormOutlookTarget.ActionPasteUpdate(Sender: TObject);
begin
  //1013 TAction(Sender).Enabled := DropEmptyTarget1.CanPasteFromClipboard;
end;
