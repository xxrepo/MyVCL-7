...
uses
  ...
  ImgList, PrViewEh, ComCtrls, Menus, ExtCtrls, ToolWin, StdCtrls, PrnDbgeh, printers;
...
procedure TPreviewFormEh.InplacePreviewSetupDialog(Sender: TObject);
begin
  PreviewEh1.Printer.OnPrinterSetupDialog := InplacePreviewSetupDialog;
...
begin
  ...
  tbtPrinterSetupDialog.Enabled := true;
