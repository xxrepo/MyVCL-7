    ...
    begin // data cell
      ...
      begin
          Result := WriteTextEh(VPrinter_Canvas, ARect, False, 0, 0,  FColCellParamsEh.Text,
             FColCellParamsEh.Alignment, tlTop, Stretch, CurColumn.EndEllipsis, 0, 0,CalcRect or CalcInfoMode) + PSY2*2;
      end;
    end else
    begin // footer cell
      ...
      Result := WriteTextEh(VPrinter_Canvas, ARect, False, 0, 0,  Value,
          AAlignment, tlTop, Stretch, Footer.EndEllipsis, 0, 0,CalcRect or CalcInfoMode) + PSY2*2;
    end;
  end;
  ...
  begin
    ...
    begin
      ...
      if PrnColumns[i].Title.Orientation = tohVertical then
          WriteTextVerticalEh(VPrinter_Canvas, r, False, PSX2, PSY2+PSY2,
            s, PrnColumns[i].Title.Alignment, tlBottom, False, CalcInfoMode)
      else
        WriteTextEh(VPrinter_Canvas, r, pghColored in Options, PSX2, PSY2, s,
      ...
      if (DBGridEh.TitleImages <> nil) and
        ...
        with PrnColumns[i].Title do
          DrawClipped(DBGridEh.TitleImages,VPrinter_Canvas,r,ImageIndex,Alignment);
