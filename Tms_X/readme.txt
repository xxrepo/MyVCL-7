!!!! TMS COMPONENT PACK v6.5 NOTICE
-----------------------------------

TMS COMPONENT PACK v6.5 is the last version with support for following Delphi & C++Builder versions:
...
If you rely on these specific Delphi & C++Builder versions, please keep a backup of 
TMS Component Pack v6.5



!!!! TMS COMPONENT PACK v6.1 TO v6.2 NOTICE
-------------------------------------------

TMS COMPONENT PACK v6.1 is the last version with support for VCL.NET
From v6.2, VCL.NET support will be removed. If you need VCL.NET support, please keep a backup of v6.1
